...
class AjustarPresencaEspecialAdminList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $actionEdit = new TDataGridAction(array('AjustarPresencaEspecialAdminForm', 'onEdit'));
        $actionEdit->setLabel('Ajustar');
        $actionEdit->setImage( "fa:street-view  blue fa-lg" );
